                      ...
                      <ul class="nav-right">
                          <li class="header-notification">
                              ...
                              <ul class="show-notification">
                                  <li>
                                      <h6>Notifications</h6>
                                      <label class="label label-danger">Novas mensagens</label>
                                  </li>
                  ...
                  <nav class="pcoded-navbar">
                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              <li class="active">
                                  <a href="menu.jsp" class="waves-effect waves-dark">
                              ...
                              <li class="pcoded-hasmenu">
                                  ...
                                  <ul class="pcoded-submenu">
                                      <li class=" ">
                                          <a href="jogos.jsp" class="waves-effect waves-dark">
                                      ...
                                      <li class=" ">
                                          <a href="consoles.jsp" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                      ...
                                      <li class=" ">
                                          <a href="celulares.jsp" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Apple iPhone 14 Pro Max 256GB Preto-espacial 6,7” 48MP </h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <div class="col-md-7 col-sm-7 ">
                      <div class="product-image">
                        <img src="assets/images/IphoneCelular.png" alt="..." />
                      </div>
                      <div class="product_gallery">
                        <a>
                          <img src="assets/images/IphoneBranco.png" alt="..." />
                        </a>
                        <a>
                    ...
                    <div class="col-md-5 col-sm-5 " style="border:0px solid #e5e5e5;">
                      ...
                      <h3 class="prod_title">Apple iPhone 14 Pro Max 256GB Preto-espacial 6,7” 48MP</h3>

                      <p>Phone 14 Pro Max. Câmera grande-angular de 48 MP para capturar detalhes impressionantes. Dynamic Island, uma nova forma de interação no iPhone. Tela Sempre Ativa. E Detecção de Acidente*, um novo recurso de segurança que liga para a emergência se você não puder. Avisos legais *O SOS de Emergência usa uma conexão de rede celular ou chamadas Wi-Fi. **A tela tem bordas arredondadas. Quando medida como um retângulo, a tela tem 6,69 polegadas na diagonal. A área real de visualização é menor. ***A duração da bateria varia de acordo com o uso e a configuração.                      <br />
                      <br />
                      <div class="">
                        <div class="product_price">
                          <h1 class="price"> 11.499,00</h1>
                          <span class="price-tax">Pix: R$ 8.729,10</span>
                          <br>
                        </div>
                      </div>
